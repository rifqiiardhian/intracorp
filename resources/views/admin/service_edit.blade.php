                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="overview-wrap">
                                    <h2 class="title-1">Edit Services</h2>
                                </div>
                            </div>
                        </div>
                        <div class="row m-t-10">
                            <div class="col-lg-12">
                                ...
                                <div class="card m-t-25">
                                    <div class="card-header"><b>Form Edit Services</b></div>
                                    <form action="{{ url('/a/service/update') }}" method="post">
                                        {{ csrf_field() }}
                                        <input type="hidden" name="id" value="{{ $servicesid }}"/>
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="name">Services Name</label>
                                                <input type="text" name="name" id="name" class="form-control" value="{{ $servicename }}"/>
                                            </div>
                                            <div class="form-group">
                                                <label for="description">Description</label>
                                                <textarea name="description" id="description" class="form-control">{{ $servicedescription }}</textarea>
                                            </div>
